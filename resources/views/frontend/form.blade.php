                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form class="application-form" id="application-form" method="POST"
                              action="{{route('form.store')}}" enctype="multipart/form-data">
                            @csrf
                            <h6 class="fw-bolder">PERSONAL DETAILS</h6>
                            <div class="row">
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label class="form-label"><span class="text-danger">*</span> Name and
                                            Surname</label>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label class="form-label"><span class="text-danger">*</span> Place of
                                            Birth</label>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label class="form-label"><span class="text-danger">*</span> Date of
                                            Birth</label>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label class="form-label"><span class="text-danger">*</span> Passaport
                                            Photo</label>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="High School Country"
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label class="form-label"><span class="text-danger">*</span> Graduation Degree (
                                            GPA ) </label>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label class="form-label"><span class="text-danger">*</span> Official Transcript
                                            "Last 3 Years"</label>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label">If taken before, a copy of language proficiency exam
                                            result (e.g. TOEFL etc.)</label>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label"><span class="text-danger">*</span> Where did you hear
                                            about us? <b>(If you apply via an agency, please write the agency name)</b>
                                        </label>
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="inlineFormCheck"
                                               name="checkbox_application_status">
                                        <label class="form-check-label" for="inlineFormCheck">
                                            ...
                                            University won't take any responsibility and can cancel the
                                            registration.<br>
                                            3. I will require my deposit fees only in case of visa rejection confirmed
                                            from the embassy.<br>
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="inlineFormCheck2">
                                            <a href="https://antalya.edu.tr/tr/kvkk-aydinlatma-metni">I approve and
                                                consent to the processing of my personal data in the ways specified in
                                                the text.</a><br>
                                        </label>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="text-end">
                                        <button type="submit" id="form_submit_button" class="btn btn-primary">Submit
                                        </button>
                                    </div>
                                </div><!--end col-->
                            </div><!--end row-->
