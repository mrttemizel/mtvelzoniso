...
<head>
    <meta charset="utf-8"/>
    <title>@stack('site_title') | ABU - Yönetim Sistemleri</title>
    ...
    @include('backend._partials._head-css')
</head>
<body>
...
@include('backend._partials._customizer')
@include('backend._partials._vendor-scripts')
</body>
</html>
